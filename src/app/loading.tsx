export default function Loading() {
  return (
    <div className="luxe-route-loading" role="status" aria-live="polite">
      ...
      <div className="luxe-route-loading__eyebrow">LUXE On Demand</div>
      <h1>Preparing your private beauty concierge.</h1>
      ...
      <style>{`
        .luxe-route-loading {
          ...
          color: #fffaf3;
          background:
            radial-gradient(circle at 50% 16%, rgba(200, 169, 110, .24), transparent 30%),
            linear-gradient(180deg, #281d28 0%, #120e14 78%);
